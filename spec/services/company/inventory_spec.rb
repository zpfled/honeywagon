...
RSpec.describe Company::Inventory do
  ...
  describe '#rented_count and #available_count' do
    it 'counts only attached units on blocking orders overlapping the window' do
      ...
      create(:rental_line_item, order: blocking_order, unit_type: standard_type, rate_plan: rate_plan_monthly, billing_period: 'monthly', quantity: 3)
      ...
      create(:rental_line_item, order: non_blocking_order, unit_type: standard_type, rate_plan: rate_plan_monthly, billing_period: 'monthly', quantity: 1)
      ...
      create(:rental_line_item, order: future_order, unit_type: standard_type, rate_plan: rate_plan_monthly, billing_period: 'monthly', quantity: 1)
  ...
  describe '#rental_count_for_period' do
    it 'counts only attached units for each billing period' do
      ...
      create(:rental_line_item, order: monthly_order, unit_type: standard_type, rate_plan: rate_plan_monthly, billing_period: 'monthly', quantity: 3)
      units.first(2).each do |unit|
      ...
      create(:rental_line_item, order: event_order, unit_type: standard_type, rate_plan: rate_plan_event, billing_period: 'per_event', quantity: 2)
  ...
  describe 'mixed billing periods' do
    it 'does not double count monthly and event units on the same order' do
      ...
      create(:rental_line_item, order: order, unit_type: standard_type, rate_plan: rate_plan_monthly, billing_period: 'monthly', quantity: 2)
      create(:rental_line_item, order: order, unit_type: standard_type, rate_plan: rate_plan_event, billing_period: 'per_event', quantity: 1)
